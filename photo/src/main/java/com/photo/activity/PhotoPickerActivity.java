...
import com.photo.adapter.PhotoAdapter;
import com.photo.model.PhotoFolder;
import com.photo.model.PhotoPick;
import com.photo.util.OtherUtils;
import com.photo.util.PhotoUtils;
...
public class PhotoPickerActivity extends BaseActivity implements PhotoAdapter.PhotoClickCallBack {
    ...
    private List<PhotoPick> mPhotoLists = new ArrayList<>();
...
//        setBarColor(this,112);
     ...
     * @param photo
     */
    private void selectPhoto(PhotoPick photo) {
        if (photo == null) {
            return;
        }
