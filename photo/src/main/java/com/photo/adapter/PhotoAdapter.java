...
import com.photo.R;
import com.photo.activity.PhotoPickerActivity;
import com.photo.model.PhotoPick;
import com.photo.util.ImageLoader;
import com.photo.util.OtherUtils;
...
public class PhotoAdapter extends BaseAdapter {
    ...
    public PhotoAdapter(Context context, List<PhotoPick> mDatas) {
        this.mDatas = mDatas;
    ...
    @Override
    public PhotoPick getItem(int position) {
    ...
    public void setDatas(List<PhotoPick> mDatas) {
        this.mDatas = mDatas;
    }
    ...
    public void setIsShowCamera(boolean isShowCamera) {
        ...
        if (mIsShowCamera) {
            PhotoPick camera = new PhotoPick(null);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(getItemViewType(position) == TYPE_CAMERA) {
            ...
            PhotoPick photo = getItem(position);
            if(mSelectMode == PhotoPickerActivity.MODE_MULTI) {
